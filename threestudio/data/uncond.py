...
class RandomCameraIterableDataset(IterableDataset, Updateable):
    ...
    def collate(self, batch) -> Dict[str, Any]:
        ...
        # 2. sample azimuth angles from a uniform distribution bounded by azimuth_range
        ...
        # 3. sample distances from a uniform distribution bounded by distance_range
